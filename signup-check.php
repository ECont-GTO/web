...
if (isset($_POST['uname']) && isset($_POST['password'])
	...
	if (empty($uname)) {
		header("Location: signup.php?error=Se requiere nombre de usuario&$user_data");
	    exit();
	}else if(empty($pass)){
        header("Location: signup.php?error=Se requiere contraseña&$user_data");
	    exit();
	}
	else if(empty($re_pass)){
        header("Location: signup.php?error=Reescriba su contraseña&$user_data");
	    exit();
	}
